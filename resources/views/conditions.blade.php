...
@section('content')
    ...
    <p>BDE CESI</p>
    <p>Société au capital de 4000 euros</p>
    <p>Siège social Lingolsheim, 2 allée des Foulons ;</p>
    <p>N° de téléphone 0388103560 ; Adresse du courrier électronique bde.strasbourg@viacesi.fr</p>
    <p>RCS de Strasbourg n°205453152</p>
    <p>N° individuel d'identification fiscal  2011652652</p>
    <p>Conditions générales de vente des produits vendus sur bde-cesi-strasbourg.com</p>
    <p>Date de dernière mise à jour 15/11/2019</p>
    <h3>Article 1 - Objet</h3>
    Les présentes conditions régissent les ventes par la société BDE CESI Strasbourg de e-commerce
    ...
    En cas de commande vers un pays autre que la France métropolitaine vous êtes l'importateur du ou des produits concernés. Des droits de douane ou autres taxes locales ou droits d'importation ou taxes d'état sont susceptibles d'être exigibles. Ces droits et sommes ne relèvent pas du ressort de la société BDE CESI Strasbourg. Ils seront à votre charge et relèvent de votre entière responsabilité, tant en termes de déclarations que de paiements aux autorités et organismes compétents de votre pays. Nous vous conseillons de vous renseigner sur ces aspects auprès de vos autorités locales.
    Toutes les commandes quelle que soit leur origine sont payables en euros.
    La société BDE CESI Strasbourg se réserve le droit de modifier ses prix à tout moment, mais le produit sera facturé sur la base du tarif en vigueur au moment de la validation de la commande et sous réserve de disponibilité.
    Les produits demeurent la propriété de la société BDE CESI Strasbourg jusqu'au paiement complet du prix.
    ...
    •	Sur Internet : bde-ces-strasbourg.com
    •	Par téléphone au 0388103560 (au tarif de 0.86 € TTC / min) du lundi au vendredi de 8h à 18h
    ...
    La société BDE CESI Strasbourg se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour quelque raison que ce soit, et plus particulièrement en cas de problème d'approvisionnement, ou en cas de difficulté concernant la commande reçue.
    <h3>Article 4 - Validation de votre commande</h3>
    Toute commande figurant sur le site Internet BDE CESI Strasbourg suppose l'adhésion aux présentes Conditions Générales. Toute confirmation de commande entraîne votre adhésion pleine et entière aux présentes conditions générales de vente, sans exception ni réserve.
    ...
    Le règlement de vos achats s'effectue par carte bancaire grâce au système sécurisé BDE CESI Strasbourg
    ...
    En cas d'exercice du droit de rétractation, la société BDE CESI Strasbourg procédera au remboursement des sommes versées, dans un délai de 14 jours suivant la notification de votre demande et via le même moyen de paiement que celui utilisé lors de la commande.
    ...
    Nos produits sont proposés tant qu'ils sont visibles sur le site BDE CESI Strasbourg et dans la limite des stocks disponibles. Pour les produits non stockés, nos offres sont valables sous réserve de disponibilité chez nos fournisseurs.
    ...
    En outre, le site Internet BDE CESI Strasbourg n'a pas vocation à vendre ses produits en quantités importantes. Par conséquent la société BDE CESI Strasbourg se réserve le droit de refuser les commandes de 100 articles identiques.
    ...
    En cas de livraisons par une transporteur, la BDE CESI Strasbourg ne peut être tenue pour responsable de retard de livraison dû exclusivement à une indisponibilité du client après plusieurs propositions de rendez-vous.
    ...
    Les produits proposés sont conformes à la législation française en vigueur. La responsabilité de la société BDE CESI Strasbourg ne saurait être engagée en cas de non-respect de la législation du pays où le produit est livré. Il vous appartient de vérifier auprès des autorités locales les possibilités d'importation ou d'utilisation des produits ou services que vous envisagez de commander.
    Par ailleurs, la société BDE CESI Strasbourg ne saurait être tenue pour responsable des dommages résultant d'une mauvaise utilisation du produit acheté.
    Enfin la responsabilité de la société BDE CESI Strasbourg ne saurait être engagée pour tous les inconvénients ou dommages inhérents à l'utilisation du réseau Internet, notamment une rupture de service, une intrusion extérieure ou la présence de virus informatiques.
    ...
    Tous les éléments du site BDE CESI Strasbourg sont et restent la propriété intellectuelle et exclusive de la société BDE CESI Strasbourg .Nul n'est autorisé à reproduire, exploiter, rediffuser, ou utiliser à quelque titre que ce soit, même partiellement, des éléments du site qu'ils soient logiciels, visuels ou sonores. Tout lien simple ou par hypertexte est strictement interdit sans un accord écrit exprès de la société BDE CESI Strasbourg
    <h3>Article 13 - Données personnelles</h3>
    La société BDE CESI Strasbourg se réserve le droit de collecter les informations nominatives et les données personnelles vous concernant. Elles sont nécessaires à la gestion de votre commande, ainsi qu'à l'amélioration des services et des informations que nous vous adressons.
    ...
    La société BDE CESI Strasbourg archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie fidèle conformément aux dispositions de l'article 1348 du Code civil.
